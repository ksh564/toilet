...
public class EventAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public EventAdapter(ArrayList<EventDATA> aritem){
    ...
    public View getView(int position, View Covertview, ViewGroup parent) {
       ...
       final Context context = parent.getContext();
        ...
        if(Covertview==null){
            ...
            Covertview=inflater.inflate(R.layout.eventlist,parent,false);
    ...
    public void additem(String index,String Nick,String Nick_img ,String Cost,int state,String date,String checktime){
